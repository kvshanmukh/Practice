...
import Practice.infra.model.Filter;
import Practice.model.Car;
import Practice.service.CarService;
...
import static Practice.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                Practice.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? Practice.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? Practice.infra.model.SortOrder.DESCENDING
                            : Practice.infra.model.SortOrder.UNSORTED;
                }
